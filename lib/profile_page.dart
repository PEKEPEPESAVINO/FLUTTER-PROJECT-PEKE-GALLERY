        ...
        body: ListView(
          children: <Widget>[
            Container(
              ...
              child: Center(
                child: CircleAvatar(radius: 75.0,backgroundImage:NetworkImage('https://www.dzoom.org.es/wp-content/uploads/2007/02/canon-mejorar-fotografo-consejos-principiantes-novatos-810x540.jpg') ,
                ),
              ),
            ),
            GridView.count(
